...
/** ≅ function because of floating point imprecision (and to make the check messages more readable
 *  when they're printed via ./test_program -l all).
 */
...
//! @copydoc approxEqual(double, double, double)
bool approxEqual(const tf2::Quaternion& l, const tf2::Quaternion& r, double delta = DEFAULT_DELTA);
